...
<div id="namediv" class="stuffbox">
	...
	<h2 style="text-align:center;font-size: 17px;">
		<?php _wsl_e("<b>Please</b> for the love of <b>God</b>, stay out of Advanced.. unless you are Advanced and you know what you are doing", PIXELPIN_PLUGIN_CATEGORY) ?>.
	</h2> 
	<br />
	...
	<div class="inside"> 
		<table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">  
		  ...
		  <tr>
			<td width="200" align="right"><strong><?php _wsl_e("WSL Base URL", PIXELPIN_PLUGIN_CATEGORY) ?> :</strong></td>
			<td> 
		  ...
		  <tr>
			<td width="200" align="right"><strong><?php _wsl_e("WSL Base PATH", PIXELPIN_PLUGIN_CATEGORY) ?> :</strong></td>
			<td> 
		  ...
		  <tr>
			<td width="200" align="right"><strong><?php _wsl_e("Hybridauth endpoint URL", PIXELPIN_PLUGIN_CATEGORY) ?> :</strong></td>
			<td> 
		  ...
		  <tr>
			<td width="200" align="right"><strong><?php _wsl_e("WSL top bar menu", PIXELPIN_PLUGIN_CATEGORY) ?> :</strong></td>
			<td>
				<select name="wsl_settings_top_bar_menu">
					<option <?php if( get_option( 'wsl_settings_top_bar_menu' ) == 1 ) echo "selected"; ?> value="1"><?php _wsl_e("Yes", PIXELPIN_PLUGIN_CATEGORY) ?></option>
					<option <?php if( get_option( 'wsl_settings_top_bar_menu' ) == 2 ) echo "selected"; ?> value="2"><?php _wsl_e("No", PIXELPIN_PLUGIN_CATEGORY) ?></option> 
				</select>
			</td>
		  </tr> 
