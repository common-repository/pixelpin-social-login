...
<div class="postbox " id="linksubmitdiv"> 
	<div class="inside">
		<div id="submitlink" class="submitbox"> 
			<h3 style="cursor: default;"><?php _wsl_e("Insights", PIXELPIN_PLUGIN_CATEGORY) ?></h3>

				<div id="misc-publishing-actions">
					<div style="padding:20px;padding-top:0px;"> 
						<h4 style="border-bottom:1px solid #ccc"><?php _wsl_e("Conversions", PIXELPIN_PLUGIN_CATEGORY) ?></h4>
						<table width="90%"> 
							<tr>
								<td width="60%"><?php _wsl_e("WP users", PIXELPIN_PLUGIN_CATEGORY) ?></td><td><?php echo $total_users; ?></td>
							</tr>
							<tr>
								<td><?php _wsl_e("WSL users", PIXELPIN_PLUGIN_CATEGORY) ?></td><td><?php echo $total_users_wsl; ?></td>
							</tr>
							<tr>
								<td><?php _wsl_e("Conversions", PIXELPIN_PLUGIN_CATEGORY) ?></td><td style="border-top:1px solid #ccc">+<b><?php echo number_format($users_conversion, 2, '.', ''); ?></b> %</td>
							</tr>
						</table>
						<?php 
						...
						?> 
						<h4 style="border-bottom:1px solid #ccc"><?php _wsl_e("By provider", PIXELPIN_PLUGIN_CATEGORY) ?></h4>
						<table width="90%">
							<?php 
								foreach( $rs1 as $item ){
							...
							?> 
							<tr>
								<td align="right">&nbsp;</td><td style="border-top:1px solid #ccc"><b><?php echo $total_users_wsl; ?></b> <?php _wsl_e("WSL users", PIXELPIN_PLUGIN_CATEGORY) ?></td>
							</tr>
						</table> 
						<?php 
						...
						?>
						<h4 style="border-bottom:1px solid #ccc"><?php _wsl_e("By gender", PIXELPIN_PLUGIN_CATEGORY) ?></h4>
						<table width="90%">
							<?php
								foreach( $rs as $item ){
									if( ! $item->meta_value ) $item->meta_value = "Unknown";
						...
						<?php 
							...
							$rs = $wpdb->get_results( $sql ); 
						?>
						<h4 style="border-bottom:1px solid #ccc"><?php _wsl_e("By age", PIXELPIN_PLUGIN_CATEGORY) ?></h4>
						<table width="90%">
							<?php
								$t_ages = 0;
								$n_ages = 0;
						...
						<tr>
							<td align="right">&nbsp;</td><td style="border-top:1px solid #ccc"><b><?php echo number_format($a_ages, 1, '.', ''); ?></b> <?php _wsl_e("yrs in average", PIXELPIN_PLUGIN_CATEGORY) ?></td>
						</tr>
						</table> 
				</div> 
			</div> 
